...
const ExamCreation = () => {
  ...
  const handleCreateExam = async () => {
    ...
    // await axios.post('https://online-exam-portal-server-tis8-pbeuzpfmn.vercel.app/api/exams', { title: titleExam, type: examType });
  ...
  const handleDelete = async (title) => {
    try {
      await axios.delete(`https://online-exam-portal-server-tis8-pbeuzpfmn.vercel.app/api/questions/objective/${title}`);
      await axios.delete(`https://online-exam-portal-server-tis8-pbeuzpfmn.vercel.app/api/questions/subjective/${title}`);
